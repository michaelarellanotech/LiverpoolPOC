...
@NgModule({
    imports: [
        ...
        apiKey: 'AIzaSyD6Si9BK8X9aK70yM63B7JtIbA8DUzH-9I'
        })
    ],
    declarations: [
        AppComponent,
    ...
    providers: [
        ...
        CarService, CountryService, EventService, NodeService, GoogleMapsAPIWrapper, GeofencingService, MarkerManager, InfoWindowManager
    ],
